...
class FormEAssySyringeController extends Controller
{
    public function index(): JsonResponse
    {
        $forms = FormEAssySyringe::all();
    ...
    public function store(Request $request): JsonResponse
    {
        ...
        $form = FormEAssySyringe::updateOrCreate($validator->validated());
        Log::create(
            [
                'action' => 'ADD FORM E ASSY SYRINGE',
                'created_date' => now(),
    ...
    {
        try{
            $form = FormEAssySyringe::where('task_id', $id)->orderBy('id', 'desc')->first();
    ...
    {
        $form = FormEAssySyringe::findOrFail($id);
