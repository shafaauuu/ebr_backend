...
use App\Models\FormE\FormENeedleAssy;
use App\Models\Log;
use Illuminate\Http\JsonResponse;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Validator;

class FormENeedleAssyController extends Controller
{
    public function index(): JsonResponse
    {
        $forms = FormENeedleAssy::all();
    ...
    public function store(Request $request): JsonResponse
    {
        ...
        $form = FormENeedleAssy::updateOrCreate($validator->validated());
        Log::create(
            [
    ...
    {
        try{
            $form = FormENeedleAssy::where('task_id', $id)->orderBy('id', 'desc')->first();
    ...
    {
        $form = FormENeedleAssy::findOrFail($id);
