...
class FormBInjectionController extends Controller
{
    public function storeQualification(Request $request): JsonResponse
    {
        ...
        foreach ($data as $item) {
            ...
            $record = FormBInjection::updateOrCreate(
                [
    ...
    {
        try {
            $form = FormBInjection::where('task_id', $id)->orderBy('id', 'desc')->first();
    ...
    {
        // Find the form by ID
        $form = FormBInjection::findOrFail($id);
