...
class FormBBlisterController extends Controller
{
    public function storeQualification(Request $request): JsonResponse
    {
        ...
        foreach ($data as $item) {
            ...
            $record = FormBBlister::updateOrCreate(
                [
    ...
    // GET /form-b-blister/{id}
    public function show($id): JsonResponse
    {
        try {
            $form = FormBBlister::where('task_id', $id)->orderBy('id', 'desc')->first();
    ...
    // PUT /form-b-blister/{id}
    public function update(Request $request, $id): JsonResponse
    {
        // Find the form by ID
        $form = FormBBlister::findOrFail($id);
