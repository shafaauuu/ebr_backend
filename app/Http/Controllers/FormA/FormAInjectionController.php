...
use App\Models\FormA\FormAInjection;
use App\Models\Log;
use Illuminate\Http\JsonResponse;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Validator;

class FormAInjectionController extends Controller
{
    // GET /form-a-injection
    public function index(): JsonResponse
    {
        $forms = FormAInjection::all();
        return response()->json($forms);
    }

    // POST /form-a-injection
    public function store(Request $request): JsonResponse
    {
        ...
        $form = FormAInjection::updateOrCreate($validator->validated());
        Log::create(
            [
                'action' => 'ADD FORM A INJECTION',
                'created_date' => now(),
    ...
    // GET /form-a-injection/{id}
    public function show($id): JsonResponse
    {
        try {
        $form = FormAInjection::where('task_id', $id)->orderBy('id', 'desc')->first();
    ...
    // PUT /form-a-injection/{id}
    public function update(Request $request, $id): JsonResponse
    {
        // Find the form by ID
        $form = FormAInjection::findOrFail($id);
