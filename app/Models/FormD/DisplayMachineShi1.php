...
class DisplayMachineShi1 extends Model
{
    protected $table = 'display_machine_shi_1';
    ...
    protected $fillable = [
        ...
        'ejector_position_eject',
        'ejector_position_first',
        'ejector_velocity_eject',
        'ejector_velocity_first',
        'temperature_z1',
        'temperature_z2',
        'temperature_z3',
        'temperature_z4',
        ...
        'plastictizing_dose2_position',
        'plastictizing_dose2_backpress',
        'plastictizing_dose2_rotation',
